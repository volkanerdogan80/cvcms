...
defined('MODULE_BLOG')          || define('MODULE_BLOG', 'blog');
defined('MODULE_SERVICE')       || define('MODULE_SERVICE', 'service');
defined('MODULE_PROJECT')       || define('MODULE_PROJECT', 'project');
defined('MODULE_PRODUCT')       || define('MODULE_PRODUCT', 'product');
defined('MODULE_GALLERY')       || define('MODULE_GALLERY', 'gallery');
