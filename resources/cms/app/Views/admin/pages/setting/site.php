    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1><?= lang('settings.text.site_setting'); ?></h1>
            </div>
                        ...
                        <div class="card">
                            ...
                            <form action="<?= current_url(); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                        ...
                                        <?php foreach (cve_language() as $key => $lang): ?>
                                            <div class="tab-pane fade <?= $key == 0 ? 'show active' : ''; ?>" id="<?= $lang->getCode(); ?>" role="tabpanel" aria-labelledby="<?= $lang->getCode(); ?>-tab">
                                                <div class="form-group row mb-4">
                                                    <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= $lang->getTitle(); ?> <?= lang('input.text.site_title'); ?></label>
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= $lang->getTitle(); ?> <?= lang('input.text.site_description'); ?></label>
                                                    <div class="col-sm-12 col-md-8">
                                                ...
                                                <div class="form-group row mb-4">
                                                    <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= $lang->getTitle(); ?> <?= lang('input.text.site_keywords'); ?></label>
                                                    <div class="col-sm-12 col-md-8">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= lang('input.text.header_logo'); ?></label>
                                        <div class="col-sm-12 col-md-8">
                                            <div id="header-image-preview" class="image-preview" style="background-repeat: no-repeat;background-image: url(<?= base_url($setting->getValue('headerLogo'))?>);background-size: contain;background-position: center center;">
                                                <label for="image-upload" id="header-image-label"><?= lang('settings.text.image_select'); ?></label>
                                                <input type="file" name="headerLogo" id="header-image-upload" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= lang('input.text.footer_logo'); ?></label>
                                        <div class="col-sm-12 col-md-8">
                                            <div id="footer-image-preview" class="image-preview" style="background-repeat: no-repeat;background-image: url(<?= base_url($setting->getValue('footerLogo'))?>);background-size: contain;background-position: center center;">
                                                <label for="image-upload" id="footer-image-label"><?= lang('settings.text.image_select'); ?></label>
                                                <input type="file" name="footerLogo" id="footer-image-upload" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= lang('input.text.mobile_logo'); ?></label>
                                        <div class="col-sm-12 col-md-8">
                                            <div id="mobile-image-preview" class="image-preview" style="background-repeat: no-repeat;background-image: url(<?= base_url($setting->getValue('mobileLogo'))?>);background-size: contain;background-position: center center;">
                                                <label for="image-upload" id="mobile-image-label"><?= lang('settings.text.image_select'); ?></label>
                                                <input type="file" name="mobileLogo" id="mobile-image-upload" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= lang('input.text.favicon'); ?></label>
                                        <div class="col-sm-12 col-md-8">
                                            <div id="favicon-image-preview" class="image-preview" style="background-repeat: no-repeat;background-image: url(<?= base_url($setting->getValue('favicon'))?>);background-size: contain;background-position: center center;">
                                                <label for="image-upload" id="favicon-image-label"><?= lang('settings.text.image_select'); ?></label>
