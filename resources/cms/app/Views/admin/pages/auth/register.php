        ...
        <div class="row">
            <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                ...
                <div class="card card-primary">
                    <div class="card-header"><h4><?= lang('Register.text.title'); ?></h4></div>
                        ...
                        <?php if(!config('system')->register): ?>
                            <div class="alert alert-warning alert-has-icon">
                                ...
                                <div class="alert-body">
                                    ...
                                    Kayıt sistemi şuan aktif değildir. Lütfen daha sonra tekrar deneyin.
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <form method="POST" action="<?= base_url(route_to('admin_register')); ?>">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    <label for="first_name"><?= lang('Input.text.first_name'); ?></label>
                                    <input id="first_name" type="text" class="form-control" name="first_name" autofocus required>
                                </div>
                                <div class="form-group col-6">
                                    <label for="sur_name"><?= lang('Input.text.last_name'); ?></label>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    <label for="password" class="d-block"><?= lang('Input.text.password'); ?></label>
                                    <input id="password" type="password" class="form-control pwstrength" data-indicator="pwindicator" name="password" required>
                                </div>
                                <div class="form-group col-6">
                                    <label for="password2" class="d-block"><?= lang('Input.text.password2'); ?></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="agree"><?= lang('Register.text.contract'); ?></label>
                                        </div>
                                    </div>
