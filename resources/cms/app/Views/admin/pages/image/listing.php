                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <input value="<?= $dateFilter ?>" name="dateFilter" placeholder="<?= lang('Image.text.date_filter_placeholder') ?>" type="text" class="form-control daterange-cus">
                                ...
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input value="<?= $search ?>" name="search" type="text" class="form-control" placeholder="<?= lang('Image.text.search') ?>">
                                        <div class="input-group-append">
