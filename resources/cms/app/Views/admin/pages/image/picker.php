<div class="modal-header">
    <h5 class="modal-title">Kullanmak İstediğin Resmi Seç</h5>
...
<div class="modal-footer">
    ...
    <?php if($type == 'editor'): ?>
        <button type="button" class="btn btn-primary image-picker-use">Resim Ekle</button>
    <?php elseif($type == 'single'): ?>
        <button type="button" class="btn btn-primary image-picker-select">Resim Seç</button>
    <?php elseif($type == 'multi'): ?>
        <button type="button" class="btn btn-primary images-picker-select">Resimleri Seç</button>
    <?php endif; ?>
</div>
