<?php
$is_rating = is_rating($content);
$score_list = cve_post_rating_score($content);
                ...
                <?php foreach ($score_list as $vote => $score): ?>
                    <div uk-grid style="margin-top: 0px">
                        <div class="uk-width-2-5@m uk-text-center">
                            <?= $vote ?> Yıldız (<span class="cve-<?= $vote ?>-text"><?= $score ?></span>)
                        </div>
                        <div class="uk-width-3-5@m">
                            <progress style="margin-bottom: 0px" class="uk-progress cve-<?= $vote ?>-value" value="<?= $score ?>" max="100"></progress>
                        </div>
                    </div>
