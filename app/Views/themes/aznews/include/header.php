                    ...
                    <div class="col-xl-12">
                        <div class="row d-flex justify-content-between align-items-center">
                            <div class="header-info-left">
                                <ul>
                                    <li><img src="<?= cve_theme_public() ?>/img/icon/header_icon1.png" alt="">34ºc, Sunny </li>
                                    <li><img src="<?= cve_theme_public() ?>/img/icon/header_icon1.png" alt="">Tuesday, 18th June, 2019</li>
                                </ul>
                            </div>
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9">
                            <div class="header-banner f-right ">
                                <img src="<?= cve_theme_public() ?>/img/hero/header_card.jpg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-10 col-lg-10 col-md-12 header-flex">
                            ...
                            <div class="main-menu d-none d-md-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a href="<?= base_url(route_to('homepage')) ?>">Home</a></li>
