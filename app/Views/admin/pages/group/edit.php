    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1><?= cve_admin_lang('General', 'now_editing') ?> "<?= $group->getTitle() ?>"</h1>
            </div>
                        ...
                        <div class="card author-box card-primary">
                            ...
                            <form action="<?= current_url(); ?>" method="POST">
                                ...
                                <div class="card-footer text-right">
                                    <button <?= $group->getSlug() == DEFAULT_ADMIN_GROUP ? 'disabled' : '' ?> type="submit" class="btn btn-success btn-block btn-lg"><?= cve_admin_lang('Buttons', 'update') ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
