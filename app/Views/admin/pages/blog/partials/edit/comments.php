<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h4><?= cve_admin_lang_path('Blogs', 'comments') ?></h4>
        </div>
        <div class="card-body">
                    ...
                    <li class="media comment-<?= $comment->id ?>" data-id="<?= $comment->id ?>">
                        ...
                        <div class="media-body">
                            <div class="media-right">
                                <div style="<?= $comment->getStatus() == STATUS_ACTIVE ? '' : 'display: none' ?>" class="text-primary comment-status-active comment-status"><?= lang('General.text.approved') ?></div>
                                <div style="<?= $comment->getStatus() == STATUS_PENDING ? '' : 'display: none' ?>" class="text-warning comment-status-pending comment-status"><?= lang('General.text.pending') ?></div>
                            </div>
