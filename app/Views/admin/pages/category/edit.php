    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1><?= cve_admin_lang('General', 'now_editing') ?> <?= $category->getTitle(); ?></h1>
            </div>
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <select name="module" class="form-control select2" required>
                                        <?php foreach (cve_module_list() as $module): ?>
                                            <option <?= $category->getModule() == $module ? 'selected': '' ?> value="<?= $module ?>"><?= cve_admin_lang('Modules', strtolower($module)) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
