                ...
                <form action="<?= current_url(); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang_path('WebmasterSettings', 'view_id') ?></label>
                                <div class="col-sm-12 col-md-8">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-8">
                                    ...
                                    <label class="custom-file-label" for="customFile"> <?= cve_admin_lang_path('WebmasterSettings', 'select_json_file') ?></label>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4><?= cve_admin_lang_path('WebmasterSettings', 'specific_code'); ?></h4>
                        </div>
                        <div class="card-body">
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang_path('WebmasterSettings', 'code'); ?></label>
