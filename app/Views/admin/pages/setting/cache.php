    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1><?= cve_admin_lang('Settings', 'cache_setting') ?></h1>

                <div class="section-header-breadcrumb">
                    <a href="<?= base_url(route_to('admin_cache_clean')) ?>" class="btn btn-primary"><i class="fas fa-tachometer-alt"></i> <?= cve_admin_lang('CacheSettings', 'clear_cache') ?></a>
                </div>
                ...
                <form action="<?= current_url(); ?>" method="post">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'html') ?></label>
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'raw') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'cache_period') ?></label>
                                <div class="col-sm-12 col-md-4">
                                    <label class="col-form-label"><?= cve_admin_lang('CacheSettings', 'html') ?> <?= cve_admin_lang('CacheSettings', 'period') ?></label>
                                    <input name="html_time" value="<?= $setting->getValue('html_time'); ?>" type="text" class="form-control" required>
                                </div>
                                <div class="col-sm-12 col-md-4">
                                    <label class="col-form-label"><?= cve_admin_lang('CacheSettings', 'raw') ?> <?= cve_admin_lang('CacheSettings', 'period') ?></label>
                                    <input name="raw_time" value="<?= $setting->getValue('raw_time'); ?>" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'system') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input <?= $setting->getValue('handler') == 'file' ? 'checked' : ''; ?> type="radio" name="handler" value="file" class="selectgroup-input">
                                            <span class="selectgroup-button"><?= cve_admin_lang('CacheSettings', 'file') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input <?= $setting->getValue('handler') == 'memcached' ? 'checked' : ''; ?> type="radio" name="handler" value="memcached" class="selectgroup-input">
                                            <span class="selectgroup-button"><?= cve_admin_lang('CacheSettings', 'memcache') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input <?= $setting->getValue('handler') == 'predis' ? 'checked' : ''; ?> type="radio" name="handler" value="predis" class="selectgroup-input">
                                            <span class="selectgroup-button"><?= cve_admin_lang('CacheSettings', 'predis') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input <?= $setting->getValue('handler') == 'redis' ? 'checked' : ''; ?> type="radio" name="handler" value="redis" class="selectgroup-input">
                                            <span class="selectgroup-button"><?= cve_admin_lang('CacheSettings', 'redis') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input <?= $setting->getValue('handler') == 'wincache' ? 'checked' : ''; ?> type="radio" name="handler" value="wincache" class="selectgroup-input">
                                            <span class="selectgroup-button"><?= cve_admin_lang('CacheSettings', 'wincache') ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'prefix') ?></label>
                                <div class="col-sm-12 col-md-8">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4><?= cve_admin_lang('CacheSettings', 'redis_settings') ?></h4>
                        </div>
                        <div class="card-body">
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'host') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <input name="redis[host]" value="<?= $setting->getValue('redis')->host; ?>" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'port') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <input name="redis[port]" value="<?= $setting->getValue('redis')->port; ?>" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'password') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <input name="redis[password]" value="<?= $setting->getValue('redis')->password; ?>" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'timeout') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <input name="redis[timeout]" value="<?= $setting->getValue('redis')->timeout; ?>" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'database') ?>></label>
                                <div class="col-sm-12 col-md-8">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4><?= cve_admin_lang('CacheSettings', 'memcache_settings') ?></h4>
                        </div>
                        <div class="card-body">
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'host') ?></label>
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('CacheSettings', 'weight') ?></label>
                                <div class="col-sm-12 col-md-8">
