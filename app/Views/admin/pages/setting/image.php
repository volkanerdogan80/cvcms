    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1><?= cve_admin_lang('Settings', 'image_setting') ?></h1>
            </div>
                ...
                <form action="<?= current_url(); ?>" method="post">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('ImageSettings', 'library') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'gd') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'imagick') ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('ImageSettings', 'delete_type') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input <?= $setting->getValue('delete') == 'all' ? 'checked' : ''; ?> type="radio" name="delete" value="all" class="selectgroup-input">
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'all') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input <?= $setting->getValue('delete') == 'original' ? 'checked' : ''; ?> type="radio" name="delete" value="original" class="selectgroup-input">
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'original') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input <?= $setting->getValue('delete') == 'db' ? 'checked' : ''; ?> type="radio" name="delete" value="db" class="selectgroup-input">
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'database') ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('ImageSettings', 'compression') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <input name="compressor" value="<?= $setting->getValue('compressor'); ?>" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('ImageSettings', 'thumbnail_size') ?></label>
                                <div class="col-sm-12 col-md-8">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4><?= cve_admin_lang('ImageSettings', 'watermark_settings') ?></h4>
                        </div>
                        <div class="card-body">
                            <div class="form-group row mb-4">
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('ImageSettings', 'text') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <input name="watermark[text]" value="<?= $setting->getValue('watermark')->text; ?>" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('ImageSettings', 'text_color') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <input name="watermark[color]" value="<?= $setting->getValue('watermark')->color; ?>" type="text" class="form-control colorpickerinput" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('ImageSettings', 'text_size') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <input name="watermark[fontSize]" value="<?= $setting->getValue('watermark')->fontSize; ?>" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('ImageSettings', 'opacity') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <input name="watermark[opacity]" value="<?= $setting->getValue('watermark')->opacity; ?>" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('ImageSettings', 'shading') ?>></label>
                                <div class="col-sm-12 col-md-8">
                                    <input name="watermark[withShadow]" value="<?= $setting->getValue('watermark')->withShadow; ?>" type="text" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-2 col-lg-2"><?= cve_admin_lang('ImageSettings', 'vAlign') ?></label>
                                <div class="col-sm-12 col-md-8">
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input <?= $setting->getValue('watermark')->vAlign == 'top' ? 'checked' : ''; ?> type="radio" name="watermark[vAlign]" value="top" class="selectgroup-input">
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'top') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'middle') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'bottom') ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12 col-md-8">
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'left') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'center') ?></span>
                                        </label>
                                        <label class="selectgroup-item">
                                            ...
                                            <span class="selectgroup-button"><?= cve_admin_lang('ImageSettings', 'right') ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
