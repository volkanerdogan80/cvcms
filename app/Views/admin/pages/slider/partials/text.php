    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="form-group mt-3">
                <input name="slider[<?= $cardId; ?>][text][<?= $random; ?>][key]" placeholder="<?= cve_admin_lang('Sliders', 'text_key') ?>" type="text" class="form-control">
            </div>
        </div>
        <div class="col-md-8">
            <div class="tab-content" id="myTabContent">
                <?php foreach (cve_language() as $key => $lang): ?>
                    ...
                    >
                        <div class="form-group mt-3">
                            <input name="slider[<?= $cardId; ?>][text][<?= $random; ?>][lang][<?= $lang->getCode(); ?>]"  placeholder="<?= cve_admin_lang('Sliders', 'text_value') ?>" type="text" class="form-control">
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
