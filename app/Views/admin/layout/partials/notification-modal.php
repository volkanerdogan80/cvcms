    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?= cve_admin_lang_path('Navbar', 'send_notification'); ?></h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body comment-modal">
                <div class="form-group">
                    <label class="col-form-label"><?= cve_admin_lang_path('Inputs', 'title'); ?></label>
                    <input id="title" type="text" name="title" class="form-control" required>
                </div>
                <div class="form-group">
                    <label class="col-form-label"><?= cve_admin_lang_path('Inputs', 'message'); ?></label>
                    <textarea id="description" name="description" class="form-control" style="height: 200px" required></textarea>
                </div>
                <div class="form-group">
                    <label class="col-form-label"><?= cve_admin_lang_path('Inputs', 'notify_link'); ?></label>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary notification_send" data-url="<?= base_url(route_to('admin_firebase_notification_send')) ?>">
                    <?= cve_admin_lang_path('Buttons', 'send'); ?>
                </button>
            </div>
        </div>
    </div>
