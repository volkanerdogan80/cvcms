...
class Language extends BaseController
{
    ...
    public function create()
    {
        if ($this->request->getMethod() == 'post'){
            ...
            return redirect()->route('admin_language_edit', [$insertID])->with('success', cve_admin_lang_path('Success', 'create_success'));
    ...
    public function delete()
    {
        if($this->request->isAJAX()){
            ...
            if($control){
                return $this->response->setJSON([
                    'status' => false,
                    'message' => cve_admin_lang_path('Errors', 'default_language_delete_failure')
                ]);
            }
        ...
        if($this->request->isAJAX()){
            ...
            if ($status == STATUS_PASSIVE){
                ...
                if ($control){
                    return $this->response->setJSON([
                        'status' => false,
                        'message' => cve_admin_lang_path('Errors', 'default_language_status_failure')
                    ]);
                }
            }
    ...
    public function default()
    {
        if($this->request->isAJAX()){
            ...
            if (!$control){
                return $this->response->setJSON([
                    'status' => false,
                    'message' => cve_admin_lang_path('Errors', 'default_language_inactive')
                ]);
            }
            ...
            return $this->response->setJSON([
                ...
                'message' => cve_admin_lang_path('Success', 'new_default_language') . $control->getTitle()
            ]);
        ...
        return $this->response->setJSON([
            'status' => false,
            'message' => cve_admin_lang_path('Errors', 'default_language_change_failure')
        ]);
    }
