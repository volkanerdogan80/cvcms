...
return [
    'title' => 'Blog Module Translation File',
    'description' => 'The data in this area contains the texts used for the blog page.',
    'text' => [
        'module' => 'Blog',
        'listing' => 'Blog Posts',
        ...
        'purge_delete_failure'   => 'You are not authorized to permanently delete a post that has not posted by you.',
    ]
];